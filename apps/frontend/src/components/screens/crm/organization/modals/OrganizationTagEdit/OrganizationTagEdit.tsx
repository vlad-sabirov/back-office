...
import { OrganizationTagEditModalProps } from '.';

export const OrganizationTagEdit: FC<OrganizationTagEditModalProps> = ({
	data,
	isOpen,
	setOpen,
	onSuccess,
	...
	const handleSubmit = async (event: FormEvent<HTMLFormElement>): Promise<void> => {
		...
		const [, error] = await CrmOrganizationTagService.updateById({ id: data.id, updateDto: { name: name.trim() } });
		if (error) {
