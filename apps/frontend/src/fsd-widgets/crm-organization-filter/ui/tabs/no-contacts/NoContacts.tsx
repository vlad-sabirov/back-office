...
import css from './no-contacts.module.scss';

const tabIndex = 'no-contacts';
...
const Content: FC = () => {
	...
	const handleClear = () => {
		actions.setFilterList({ ...filter, userIds: undefined, withoutContacts: undefined, search: undefined, tags: undefined });
		setSearchValue('');
	};
...
const Tab: FC = () => {
	return (
		<Tabs.Tab value={tabIndex} icon={<Icon name={'crm-filter-archive'} />}>
			Без контактов
		</Tabs.Tab>
	);
};

export const NoContacts = { Tab, Content };
