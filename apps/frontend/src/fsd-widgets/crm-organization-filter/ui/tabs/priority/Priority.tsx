...
const Content: FC = () => {
	...
	const handleClear = () => {
		actions.setFilterList({ ...filter, userIds: [1], isVerified: true, search: undefined, tags: undefined });
		setSearchValue('');
	};
...
const Tab: FC = () => {
	return (
		<Tabs.Tab value={tabIndex} icon={<Icon name={'crm-filter-priority'} />}>
			Приоритетные
		</Tabs.Tab>
	);
};

export const Priority = { Tab, Content };
